...
import { IndividualListingLoadingState } from "@/components/loading-states";
...
export default function ListingPage() {
  ...
  // Show loading state with consistent header
  if (isLoading && reviews.length === 0) {
    return <IndividualListingLoadingState />;
  }
            ...
            <div className="flex justify-between items-start mb-6">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-6 text-gray-600 mb-4">
                  <span className="flex items-center gap-1">📍 London, UK</span>
                  {stats && (
                    <>
                    ...
                    <div className="text-sm">
                      ...
                      {stats.sources.google.averageRating > 0 && (
                        <div className="text-xs text-gray-500">
                          Avg:{" "}
                          {(stats.sources.google.averageRating / 2).toFixed(1)}
                          /5
                        </div>
                      )}
                    </div>
          ...
          <div className="flex flex-col bg-white rounded-lg border p-6 relative">
            ...
            <div className="prose prose-gray max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4">
                Welcome to {listingName}, a stunning premium serviced apartment
                located in the heart of London. This beautifully appointed
                property offers the perfect blend of luxury, comfort, and
                convenience for both short and extended stays.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Modern & updated</div>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                <span className="text-2xl">🌟</span>
                <div>
                  <div className="font-medium text-gray-900">Highly Rated</div>
                  <div className="text-sm text-gray-600">
              ...
              <div className="flex flex-col bg-white rounded-lg border p-6">
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-blue-800 text-sm">
                    ...
                    set it apart from standard accommodations. Our attention to
                    detail ensures a luxury experience throughout your stay.
                  </p>
                </div>
              </div>
